...
[OpenSaola](https://github.com/harmonycloud/opensaola) 的命令行管理工具 — 管理 Kubernetes 上的中间件生命周期：包安装、实例创建、状态查询、版本升级与资源清理。
...
Saola 通过 OpenSaola Operator 包管理以下中间件：

| 中间件 | 说明 | 仓库 |
|--------|------|------|
| MySQL | 关系型数据库，支持主从和代理模式 | [harmonycloud/mysql](https://github.com/harmonycloud/mysql) |
| PostgreSQL | 高级关系型数据库，支持高可用 | [harmonycloud/postgresql](https://github.com/harmonycloud/postgresql) |
| Apache Kafka | 分布式事件流平台 | [harmonycloud/kafka](https://github.com/harmonycloud/kafka) |
| Redis | 内存数据存储，支持哨兵和集群模式 | [harmonycloud/redis](https://github.com/harmonycloud/redis) |
| Elasticsearch | 分布式搜索和分析引擎 | [harmonycloud/elasticsearch](https://github.com/harmonycloud/elasticsearch) |
| Apache ZooKeeper | 分布式协调服务 | [harmonycloud/zookeeper](https://github.com/harmonycloud/zookeeper) |
| RabbitMQ | AMQP 消息代理 | [harmonycloud/rabbitmq](https://github.com/harmonycloud/rabbitmq) |
...
- [OpenSaola 技术文档](https://github.com/harmonycloud/opensaola/blob/master/docs/opensaola-technical.md)
- [包适配指南](https://github.com/harmonycloud/opensaola/blob/master/docs/opensaola-packaging.md)
- [故障排查指南](https://github.com/harmonycloud/opensaola/blob/master/docs/troubleshooting_zh.md)
